...
requirements: psutil (can be installed with pip)

This version here won't be updated!

You can find the latest version here: https://github.com/jabbalaci/Bash-Utils
